...
plugin_identifier = "autocalibration"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_autocalibration"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "OctoPrint-Autocalibration"
...
# module
plugin_description = """Calibrate X/Y/Z axis backlash without human interaction via endstops"""
